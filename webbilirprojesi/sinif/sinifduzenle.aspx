<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sinifduzenle.aspx.cs" Inherits="webbilirprojesi.sinif.sinifduzenle" %>
                     ...
                     <form id="form1" runat="server">
                        ...
                        <asp:TextBox runat="server" ID="txtClass" CssClass="form-control" placeholder="Write A or B ..." Width="360px" />
                         ...
                         <br />
                           ...
                           <asp:Button Text="Duzenle" ID="btnKaydet" runat="server" CssClass="btn btn-success" OnClick="btnKaydet_Click"/>
